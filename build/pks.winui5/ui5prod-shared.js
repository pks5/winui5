...
module.exports = {
	...
	getProdConfig : function(oOptions){
		...
		sSubPathWwwApp = sSubPathWww + "/app",
		...
		sPathToAppRoot = sPathToRoot + sSubPathWwwApp + "/",
		sPathToLocalReleaseRoot = sPathToRoot + sSubPathRelease + "/",
		sPathToTargetRoot = sPathToRoot + "../" + oOptions.targetProject + "/",
		...
		sFolderReleaseTargetExamples = sPathToTargetRoot + sSubPathWww + "/apps/site_pksoftware/pks_store/data/product/" + sProductName + "/examples/",
		...
		return {
			...
			folderReleaseTargetExamples : sFolderReleaseTargetExamples,
