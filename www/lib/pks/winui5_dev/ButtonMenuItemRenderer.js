 ...
 * WinUi5
 *
 * pks.winui5.ButtonMenuItemRenderer
 * 
...
sap.ui.define(["./library", "./ItemRenderer"], function(winui5Lib, ItemRenderer) {
	...
	var ButtonMenuItemRenderer = {};
	
	/**
	 * Renders a file item.
	 */
	ButtonMenuItemRenderer.render = function(rm, oMenuItem){
		...
		sIcon && rm.write(winui5Lib.createIcon(sIcon, oMenuItem.createStyleClass("ico")));
        
		//START file
		if(sText){
    		rm.write('<div class="' + oMenuItem.createStyleClass("tex") + '" id="' + oMenuItem.createSubId("tex") + '">');
