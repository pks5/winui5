...
sap.ui.define(["./library"], function(winui5Lib){
    ...
    InstanceEvent.press = function(oEvent){
        var mParam = oEvent.getParameters(),
            sOverlayTrigger = this.getOverlayTrigger();
        
        if(sOverlayTrigger === winui5Lib.OverlayTrigger.PrimaryPress && mParam.origin === winui5Lib.PressOrigin.PrimaryPress){
        ...
        else if(sOverlayTrigger === winui5Lib.OverlayTrigger.SecondaryPress && mParam.origin === winui5Lib.PressOrigin.SecondaryPress){
    ...
    InstanceEvent.selectionChange = function(oEvent){
     ...
     OverlayEvent.afterClose = function(oEvent){ 
         ...
         if(sCloseReason === winui5Lib.OverlayCloseReason.Cancel 
             ...
             var oControl = this.retrieveOwner().getItemContainer();
     ...
     Trait.setInstanceEvents = function(bPreviousOverlayEnabled, sPreviousOverlayTrigger){
         ...
         if(sPreviousOverlayTrigger && (!bOverlayEnabled || sOverlayTrigger === OverlayTrigger.Manual || sPreviousOverlayTrigger !== sOverlayTrigger)){
             ...
             if(sPreviousOverlayTrigger === OverlayTrigger.PrimaryPress || sPreviousOverlayTrigger === OverlayTrigger.SecondaryPress){
         ...
         if(bOverlayEnabled){
             ...
             //TODO other press variants
             if(sOverlayTrigger === OverlayTrigger.PrimaryPress || sOverlayTrigger === OverlayTrigger.SecondaryPress){
      ...
      * @class
      * Class that provides methods to add context menu support to item containers.
      * @alias pks.winui5.ItemContainerOverlaySupport
      * @author Jan Philipp Knoeller
      * @version 1.0.8-SNAPSHOT
      * @public
      */
     var ItemContainerOverlaySupport = {};
     ...
     */
    ItemContainerOverlaySupport.addMethods = function(oProto, bIsItem){
    ...
    //Return Constructor
    return ItemContainerOverlaySupport;
});