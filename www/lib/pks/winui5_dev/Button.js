...
sap.ui.define(["./library", "./ButtonBase", "./ElementHelper", "./ButtonRenderer"], function(winui5Lib, ButtonBase, ElementHelper, ButtonRenderer){
     ...
     * @constructor
     * @public
     * @alias pks.winui5.Button
     * 
     */
    var Button = ButtonBase.extend("pks.winui5.Button", /** @lends pks.winui5.Button.prototype */ { 
        metadata : oMetadata,
        renderer: ButtonRenderer
    }),
    /**
     * @alias pks.winui5.Button.prototype
     */
    ...
    ButtonProto.getAdditionalStyleClass = function(){
        return ButtonBase.getStylePrefix() + " " + ButtonBase.prototype.getAdditionalStyleClass.call(this);
    };
